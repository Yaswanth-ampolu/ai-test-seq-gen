...
IMPORTANT:
- Have a natural conversation with me if I'm just chatting
- ONLY check specifications when I explicitly request a test sequence
- DO NOT use markdown code blocks (```json). Use the EXACT markers above if needed.
